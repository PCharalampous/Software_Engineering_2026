...
public class NewApplicationScreen {
    ...
    // ΔΙΟΡΘΩΘΗΚΕ: Ο constructor δέχεται την ProfileScreen για να μην χάνεται το reference
    public NewApplicationScreen(ProfileScreen profileScreen) {
        this.profileScreen = profileScreen;
    }

    public void fillForm() {
        this.formStage = new Stage();
        formStage.setTitle("HOMY - New Application");
            ...
            try {
                ...
                ConfirmationScreen confirmDialog = new ConfirmationScreen(
                    ...
                    () -> {
                        ...
                        newApp.saveApplication(currentUserId); 
                        
                        formStage.close();
                        
                        SuccessScreen.display("Your ad was successfully created and is pending approval!");
                        
                        // ΔΙΟΡΘΩΘΗΚΕ: Ανανεώνουμε αμέσως το UI/Counter του ProfileScreen
                        if (profileScreen != null) {
                            profileScreen.showProfileMain();
                        }
                        
                        // Ανοίγουμε τη λίστα περνώντας ξανά το reference για να συνεχίσει να δουλεύει και το Cancel
                        new MyApplicationScreen(profileScreen).display();
                    }
                );
                confirmDialog.show();
        ...
        formStage.setScene(new Scene(root, 420, 720));
        formStage.show();
    }
