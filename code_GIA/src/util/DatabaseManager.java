...
public class DatabaseManager {
    ...
    /**
     * Επιστρέφει την ενεργή σύνδεση με τη βάση δεδομένων.
     * Αν δεν υπάρχει ή έχει κλειστεί, τη δημιουργεί ξανά διαβάζοντας το αρχείο config.properties.
     */
    public static Connection getConnection() {
        try {
            // ΔΙΟΡΘΩΣΗ: Έλεγχος αν η σύνδεση είναι null Ή αν έχει ήδη κλείσει
