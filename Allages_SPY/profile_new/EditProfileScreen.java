    ...
    public Node getView() {
        ...
        btnSave.setOnAction(e -> {
            if (!manager.validateChanges(tfName.getText())) {
                ...
                parentScreen.showProfileMain(); // ← ΠΡΩΤΑ το UI update
                SuccessScreen.display("ProfileUpdatedScreen", "PROFILE UPDATED", "Changes saved successfully."); // ← ΜΕΤΑ το popup
            }   
});
        ...
        Label lblPrefs = new Label("PREFERENCES"); lblPrefs.setStyle("-fx-font-size:10px; -fx-font-weight:bold; -fx-text-fill:#888888;");
