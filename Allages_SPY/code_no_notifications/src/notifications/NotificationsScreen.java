...
public class NotificationsScreen {
    // --- Προσθήκη στατικού reference για το background thread ---
    public static NotificationsScreen activeInstance = null;
    ...
    public void display() {
        ...
        // Ορίζουμε το activeInstance
        activeInstance = this;
        // Όταν κλείνει το παράθυρο, το καθαρίζουμε για να μην τρέχει τζάμπα ο poller
        this.primaryStage.setOnHiding(e -> activeInstance = null);
        ...
        if (shown.isEmpty()) {
            ...
            shown.forEach(n -> {
                ...
                row.setOnMouseClicked(e -> { 
                    ...
                    // Προσοχή: Επειδή πειράξαμε τον Constructor, αν η NotificationDetailsScreen
                    // χτυπήσει, απλά επιβεβαίωσε ότι δέχεται το αντικείμενο 'n'.
