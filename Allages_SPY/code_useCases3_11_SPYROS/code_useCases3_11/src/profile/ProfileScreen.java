...
public class ProfileScreen {
    ...
    public ProfileScreen() {
        ...
        // Φόρτωσε το profile από τη βάση
        UserProfile defaultUser = ManageProfileClass.loadFromDatabase(1);
        if (defaultUser == null) {
            System.err.println("Αδυναμία φόρτωσης από βάση, χρήση default τιμών.");
            defaultUser = new UserProfile(
                1, "Makis Kosta", "@makisk",
        ...
        // Φόρτωσε τα pending requests από τη βάση
        this.incomingRequests = ManageProfileClass.loadRequestsFromDatabase(defaultUser.room_id);
    ...
    public void showProfileMain() {
        ...
        List<Application> myApps = Application.loadUserApplications(1); // 1 = Hardcoded user_id
