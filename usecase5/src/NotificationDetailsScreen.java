...
public class NotificationDetailsScreen {
    ...
    public void show() {
        ...
        // Από εδώ καλείται η εξωτερική κλάση ConfirmationScreen (alt3)
        btnDel.setOnAction(e -> {
            ConfirmationScreen confScreen = new ConfirmationScreen(dlg, ownerStage, notification, manager, parentScreen);
            confScreen.show();
        });
