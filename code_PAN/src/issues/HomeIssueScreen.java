...
public class HomeIssueScreen extends VBox {
    ...
    // 🌟 PERSISTENT SESSION TRACKING: Handles multi-roommate calculations seamlessly
    ...
    private void buildUI() {
        ...
        navigateCreateBtn.setStyle("-fx-background-color: #a855f7; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10 24; -fx-background-radius: 6; -fx-cursor: hand;");
